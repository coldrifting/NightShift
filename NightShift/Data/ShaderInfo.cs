...
public class ShaderInfo(Shader dayShader, Shader nightShader)
{
    ...
    private static readonly Shader ShaderAlphaTranslucent = Shabby.Shabby.FindShader("KSP/Alpha/Translucent");
    ...
    private static readonly Shader ShaderNightShiftAlphaTranslucent = Shabby.Shabby.FindShader("NightShift/AmbientOverride/AlphaTranslucent");
    ...
    public static readonly ShaderInfo ShaderMapAlphaTranslucent = new(ShaderAlphaTranslucent, ShaderNightShiftAlphaTranslucent);
