...
Shader "NightShift/AmbientOverride/Emissive/Bumped Specular"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutput o)
        {
            ...
            float4 emissiveMask = tex2D(_Emissive, i.uv_MainTex);
            float4 emissive = emissiveMask * _EmissiveColor;

            o.Albedo = max(color, emissive);
            o.Emission = max(color * _AmbientLightOverride, emissive);
